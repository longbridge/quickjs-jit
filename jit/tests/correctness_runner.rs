use rquickjs_jit::correctness::{
    ...
    classify_features_with_config, discover_test262, parse_test262, Exclusion, ExclusionManifest,
    FeatureDisposition, NegativePhase, RunMode, StructuredProgram, SuiteReport, Test262Variant,
};
use std::fs;
...
fn canonical_observation_preserves_values_json_loses() {
    ...
    assert!(source.contains("Reflect.ownKeys"));
}
