...
use crate::llrt_utils::option::{Null, Undefined};
    ...
    pub(crate) fn call(
        ...
        match self {
            ...
            PullAlgorithm::Tee(state) => {
                crate::llrt_stream_web::readable::stream::tee::tee_pull_algorithm(
                    ctx,
                    state.clone(),
                )
            }
    ...
    pub(crate) fn call(
        ...
        match self {
            ...
            CancelAlgorithm::Tee1(state) => {
                crate::llrt_stream_web::readable::stream::tee::tee_cancel_algorithm(
                    ctx,
                    state.clone(),
                    reason,
                    0,
