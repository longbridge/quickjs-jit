...
use crate::llrt_crypto::provider::{
    AesMode, CryptoError, CryptoProvider, HmacProvider, SimpleDigest,
};
use crate::llrt_crypto::subtle::EllipticCurve;
...
impl CryptoProvider for GraviolaProvider {
    ...
    fn generate_aes_key(&self, length_bits: u16) -> Result<Vec<u8>, CryptoError> {
        ...
        Ok(crate::llrt_crypto::random_byte_array(
    ...
    fn generate_hmac_key(
        ...
        Ok(crate::llrt_crypto::random_byte_array(length_bytes))
    }
