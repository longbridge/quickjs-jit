...
use crate::llrt_utils::{bytes::ObjectBytes, iterable_enum, result::ResultExt};
use rquickjs::{
    class::Trace, function::Opt, prelude::This, Class, Ctx, IntoJs, JsLifetime, Result, Value,
};

use super::encoded_bytes;
use crate::llrt_crypto::provider::{CryptoError, CryptoProvider, HmacProvider, SimpleDigest};
use crate::llrt_crypto::CRYPTO_PROVIDER;
...
type ProviderDigest = <crate::llrt_crypto::provider::DefaultProvider as CryptoProvider>::Digest;
type ProviderHmac = <crate::llrt_crypto::provider::DefaultProvider as CryptoProvider>::Hmac;
