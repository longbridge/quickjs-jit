...
__NOTE:__ Usually you shouldn't use this crate directly. Use the
[`quickjs-jit`](https://crates.io/crates/quickjs-jit) package instead, imported
under the `rquickjs` dependency name.
